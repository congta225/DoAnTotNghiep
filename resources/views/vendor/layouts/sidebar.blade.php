...
<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      <li><a class="{{setActive(['vendor.dashbaord'])}}" href="{{route('vendor.dashbaord')}}"><i class="fas fa-tachometer"></i>Thống kê</a></li>
      <li><a class="" href="{{route('home')}}"><i class="fas fa-home"></i>Quay về trang chủ</a></li>
      ...
      <li><a class="{{setActive(['vendor.reviews.index'])}}" href="{{route('vendor.reviews.index')}}"><i class="fas fa-star"></i> Đánh giá</a></li>
        ...
        <li><a class="{{setActive(['vendor.reviews.index'])}}" href="{{route('vendor.withdraw.index')}}"><i class="fas fa-credit-card"></i> Rút tiền</a></li>

      <li><a class="{{setActive(['vendor.shop-profile.index'])}}" href="{{route('vendor.shop-profile.index')}}"><i class="far fa-user"></i> Hồ sơ người bán</a></li>
