              ...
              <div class="row">
                ...
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item red" href="javascript:;">
                      <i class="fas fa-cart-plus"></i>
                      <p>Todays Earnings</p>
                      <h4 style="color:#ffff">{{number_format($todaysEarnings,0,'.','.')}}{{$settings->currency_icon}}</h4>
                    </a>
                </div>
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item red" href="javascript:;">
                      ...
                      <h4 style="color:#ffff">{{number_format($monthEarnings,0,'.','.')}}{{$settings->currency_icon}}</h4>
                    </a>
                </div>
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item red" href="javascript:;">
                      ...
                      <h4 style="color:#ffff">{{number_format($yearEarnings,0,'.','.')}}{{$settings->currency_icon}}</h4>
                    </a>
                </div>
                ...
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item red" href="javascript:;">
                      <i class="fas fa-cart-plus"></i>
                      <p>Total Earnings</p>
                      <h4 style="color:#ffff">{{number_format($toalEarnings,0,'.','.')}}{{$settings->currency_icon}}</h4>
                    </a>
                </div>
                <div class="col-xl-2 col-6 col-md-4">
