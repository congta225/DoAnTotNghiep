...
@section('title')
{{$settings->site_name}} || Tra cứu đơn hàng
@endsection
                    ...
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        ...
                        <form class="tack_form" action="{{route('product-traking.index')}}" method="GET">
                            ...
                            <div class="wsus__track_input">
                                ...
                                <input type="text" placeholder="Nhập vào mã đơn hàng" name="tracker" value="{{@$order->invocie_id}}">
                            </div>
                    ...
                    <div class="col-xl-12">
                        <ul class="progtrckr" data-progtrckr-steps="4">
                            ...
                            @if (@$order->order_status == 'canceled')
                                <li class="icon_four red_mark">Hủy đơn hàng</li>
                            @else
