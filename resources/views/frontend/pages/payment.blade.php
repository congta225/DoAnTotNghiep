                ...
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 m-auto">
                                        <div class="wsus__payment_area">
                                            <a class="nav-link common_btn text-center" href="{{route('user.paypal.payment')}}">Thanh toán với paypal</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__pay_booking_summary" id="sticky_sidebar2">
                            ...
                            <p>Miễn phí vận chuyển(+) : <span>{{number_format(getShppingFee(),0,'.','.')}}{{$settings->currency_icon}}</span></p>
                            <p>Mã giảm giá(-) : <span>{{number_format(getCartDiscount(),0,'.','.')}}{{$settings->currency_icon}}</span></p>
                            <h6>Tổng tiền: <span>{{number_format(getFinalPayableAmount(),0,'.','.')}}{{$settings->currency_icon}}</span></h6>
                        </div>
                    </div>
                </div>
            </div>
