                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-md-7 col-lg-7">
                        <div class="wsus__pro_details_text">
                            ...
                            @if ($product->qty > 0)
                            <p class="wsus__stock_area"><span class="in_stock">Trong kho</span> ({{$product->qty}} sản phẩm)</p>
                            @elseif ($product->qty === 0)
                            <p class="wsus__stock_area"><span class="in_stock">Hết hàng</span> ({{$product->qty}} sản phẩm)</p>
                            @endif
                            @if (checkDiscount($product))
                                <h4>{{number_format($product->offer_price,0,'.','.')}}{{$settings->currency_icon}} <del>{{number_format($product->price,0,'.','.')}}{{$settings->currency_icon}}</del></h4>
                            @else
                                                ...
                                                <select class="select_2" name="variants_items[]">
                                                    @foreach ($variant->productVariantItems as $variantItem)
                                                        @if ($variantItem->status != 0)
                                                            <option value="{{$variantItem->id}}" {{$variantItem->is_default == 1 ? 'selected' : ''}}>{{$variantItem->name}} ({{number_format($variantItem->price,0,'.','.')}}đ)</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            </div>
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab3" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-contact" aria-selected="false">Được cung cấp bởi</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                <div class="wsus__pro_det_vendor_text">
                                                    ...
                                                    <p><span>Tên nhà cung cấp:</span> {{$product->vendor->shop_name}}</p>
                                                    ...
                                                    {{-- <a href="#" class="see_btn">Xem thêm</a> --}}
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                ...
                                                <div class="col-xl-4 col-lg-5 mt-4 mt-lg-0">
                                                    ...
                                                    <div class="wsus__post_comment rev_mar" id="sticky_sidebar3">
                                                        ...
                                                        <form action="{{route('user.review.create')}}" enctype="multipart/form-data" method="POST">
                                                            @csrf
                                                            <p class="rating">
                                                                <span>Bạn cho bao nhiêu sao cho sản phẩm này? : </span>
                                                            </p>
