...
@section('title')
{{$settings->site_name}} || Sản phẩm của nhà cung cấp
@endsection
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">Sản phẩm của nhà cung cấp</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="wsus__product_item">
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                @if(checkDiscount($product))
                                                    <p class="wsus__price">{{number_format($product->offer_price,0,'.','.')}}{{$settings->currency_icon}} <del>{{number_format($product->price,0,'.','.')}}{{$settings->currency_icon}}</del></p>
                                                @else
                                                    <p class="wsus__price">{{number_format($product->price,0,'.','.')}}{{$settings->currency_icon}}</p>
                                                @endif
