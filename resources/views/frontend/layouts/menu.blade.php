            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        <li><a class="{{setActive(['about'])}}" href="{{route('about')}}">Về chúng tôi</a></li>
                        <li><a class="{{setActive(['contact'])}}" href="{{route('contact')}}">Liên hệ</a></li>


                    </ul>
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        <li><a href="{{route('product-traking.index')}}">Hành trình đơn hàng</a></li>
                        @if (auth()->check())
                        @if (auth()->user()->role === 'user')
                        <li><a href="{{route('user.dashboard')}}">Tài khoản của tôi</a></li>
                        @elseif (auth()->user()->role === 'vendor')
                        <li><a href="{{route('vendor.dashbaord')}}">Bảng điều khiển nhà cung cấp</a></li>
                        @elseif (auth()->user()->role === 'admin')
                        <li><a href="{{route('admin.dashbaord')}}">Bảng điều khiển quản trị</a></li>
