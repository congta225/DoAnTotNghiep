...
<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a class="" href="{{url('/')}}"><i class="fas fa-home"></i>Quay về trang chủ</a></li>

      @if (auth()->user()->role === 'vendor')
      <li><a class="{{setActive(['vendor.dashbaord'])}}" href="{{route('vendor.dashbaord')}}"><i class="fas fa-tachometer"></i>Quay về trang nhà cung cấp</a></li>
      @endif
      ...
      @if (auth()->user()->role !== 'vendor')
      <li><a class="{{setActive(['user.vendor-request.*'])}}" href="{{route('user.vendor-request.index')}}"><i class="far fa-user"></i> Yêu cầu thành nhà cung cấp?</a></li>
      @endif
      <li>
