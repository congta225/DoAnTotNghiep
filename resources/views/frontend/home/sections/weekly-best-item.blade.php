                            ...
                            <a class="wsus__hot_deals__single" href="{{route('product-detail', $item->slug)}}">
                                ...
                                <div class="wsus__hot_deals__single_text mt-2">
                                    ...
                                    <p class="wsus__rating">
                                        ...
                                        <span>({{$item->reviews_count}} Đánh giá)</span>
                                    </p>
                                    @if (checkDiscount($item))
                                        <p class="wsus__tk">{{number_format($item->offer_price,0,'.','.')}}{{$settings->currency_icon}}<del>{{number_format($item->price,0,'.','.')}}{{$settings->currency_icon}}</del></p>
                                    @else
