                    ...
                    <form action="{{route('admin.products.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select id="inputState" class="form-control" name="product_type">
                                <option value="">------------------- Chọn ------------------</option>
                                <option {{$product->product_type == 'new_arrival' ? 'selected' : ''}} value="new_arrival">Hàng mới về</option>
                                <option {{$product->product_type == 'featured_product' ? 'selected' : ''}} value="featured_product">Nổi bật</option>
                                <option {{$product->product_type == 'top_product' ? 'selected' : ''}} value="top_product">Hàng đầu</option>
                                <option {{$product->product_type == 'best_product' ? 'selected' : ''}} value="best_product">Bán chạy</option>
                            </select>
                        </div>
