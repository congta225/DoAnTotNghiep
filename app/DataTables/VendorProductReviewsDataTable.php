...
class VendorProductReviewsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('status', function($query){
            if($query->status == 1){
                ...
                return "<span class='badge bg-waring'>Chờ duyệt</span>";
            }
        })
    ...
    public function getColumns(): array
    {
        return [
            Column::make('id'),
            Column::make(['data' => 'product', 'title' => 'Sản phẩm']),
            Column::make(['data' => 'user', 'title' => 'Tên người dùng']),
            Column::make(['data' => 'rating', 'title' => 'Số sao']),
            Column::make(['data' => 'review', 'title' => 'Đánh giá']),
