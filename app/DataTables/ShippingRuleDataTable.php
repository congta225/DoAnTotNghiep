...
class ShippingRuleDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('type', function($query){
                if($query->type === 'min_cost'){
                    return '<i class="badge badge-primary">Số tiền tối thiểu</i>';
                }else {
                    return '<i class="badge badge-success">Giá cố định</i>';
                }
            })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('id'),
            Column::make(['data' => 'name', 'title' => 'Tên']),
            Column::make(['data' => 'type', 'title' => 'Loại quy tắc']),
            Column::make(['data' => 'min_cost', 'title' => 'Số tiền tối thiểu']),
            Column::make(['data' => 'cost', 'title' => 'Giá ship']),
