...
class VendorRequestDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function($query){
                if($query->status == 0){
                    ...
                    return "<span class='badge bg-success'>Chấp nhận</span>";
                }
            })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('id'),
            Column::make(['data' => 'user_name', 'title' => 'Tên tài khoản']),
            Column::make(['data' => 'shop_name', 'title' => 'Tên nhà cung cấp']),
            Column::make(['data' => 'shop_email', 'title' => 'Email']),
