...
class SellerProductsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            ...
            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
              ...
              <a class="dropdown-item has-icon" href="'.route('admin.products-variant.index', ['product' => $query->id]).'"><i class="far fa-file"></i> Màu sắc, kích thước</a>
            </div>
          </div>';
        ...
        ->addColumn('type', function($query){
            switch ($query->product_type) {
                ...
                case 'featured_product':
                    return '<i class="badge badge-warning">Nổi bật</i>';
                    break;
                case 'top_product':
                    return '<i class="badge badge-info">Hàng đầu</i>';
                    break;

                case 'best_product':
                    return '<i class="badge badge-danger">Bán chạy</i>';
                    break;
    ...
    public function getColumns(): array
    {
        return [
            Column::make('id'),
            Column::make(['data' => 'vendor', 'title' => 'Nhà cung cấp']),
            Column::make(['data' => 'image', 'title' => 'Ảnh sản phẩm']),
            Column::make(['data' => 'price', 'title' => 'Giá sản phẩm']),
            Column::make(['data' => 'type', 'title' => 'Loại sản phẩm']),
            Column::make(['data' => 'status', 'title' => 'Trạng thái']),
            Column::make(['data' => 'approve', 'title' => 'Duyệt sản phẩm']),
