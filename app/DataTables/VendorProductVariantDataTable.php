...
class VendorProductVariantDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $veriantItems = "<a href='".route('vendor.products-variant-item.index', ['productId' => request()->product, 'variantId' => $query->id])."' class='btn btn-info btn-space-right'><i class='far fa-edit'></i> Mục biến thể</a>";
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make(['data' => 'name', 'title' => 'Tên biến thể']),
