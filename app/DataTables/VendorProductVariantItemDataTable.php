...
class VendorProductVariantItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('is_default', function($query){
            if($query->is_default == 1){
                return '<i class="badge bg-success">Mặc định</i>';
            }else {
                return '<i class="badge bg-danger">Không</i>';
            }
        })
    ...
    public function getColumns(): array
    {
        return [
            Column::make('id'),
            Column::make(['data' => 'name', 'title' => 'Tên item']),
            Column::make(['data' => 'variant_name', 'title' => 'Tên biến thể']),
            Column::make(['data' => 'price', 'title' => 'Giá']),
            Column::make(['data' => 'is_default', 'title' => 'Mặc định?']),
